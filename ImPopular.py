...
#area = str(sys.argv[1][1:4])
firstpart = str(sys.argv[2][0:3])
secondpart = str(sys.argv[2][4:len(sys.argv[2])])
...
if "T-MOBILE" in provider.text:
    email = "1"+area+firstpart+secondpart+"@tmomail.net"
elif "VERIZON WIRELESS" in provider.text:
    email = "1"+area+firstpart+secondpart+"@vtext.com"
elif "SPRINT" in provider.text:
    email = "1"+area+firstpart+secondpart+"@pm.sprint.com"
