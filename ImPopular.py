...
area = str(sys.argv[1][0:3])
firstpart = str(sys.argv[1][3:6])
secondpart = str(sys.argv[1][6:len(email)])
...
if "T-MOBILE" in provider.text:
    email = "1"+sys.argv[1]+"@tmomail.net"
elif "VERIZON WIRELESS" in provider.text:
    email = "1"+sys.argv[1]+"@vtext.com"
elif "SPRINT" in provider.text:
    email = "1"+sys.argv[1]+"@pm.sprint.com"
elif "CINGULAR WIRELESS" in provider.text:
    email = sys.argv[1]+"@txt.att.net"
